...
import somebody_z.me.zuimusic.widget.indexbar.database.DataObserver;
import somebody_z.me.zuimusic.widget.indexbar.database.HeaderFooterDataObserver;
...
public class IndexableLayout extends FrameLayout {
    ...
    public void setIndexBarVisibility(boolean visible) {
        mIndexBar.clearAnimation();

        if (visible) {
            mIndexBar.setVisibility(VISIBLE);
            mIndexBar.startAnimation(showAnimation);
        } else {
            mIndexBar.startAnimation(hideAnimation);
        }
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mBarTextColor = a.getColor(R.styleable.IndexableRecyclerView_indexBar_textColor, ContextCompat.getColor(context, R.color.Gray));
            mBarTextSize = a.getDimension(R.styleable.IndexableRecyclerView_indexBar_textSize, getResources().getDimension(R.dimen.middle_text_size));
            mBarFocusTextColor = a.getColor(R.styleable.IndexableRecyclerView_indexBar_selectedTextColor, ContextCompat.getColor(context, R.color.colorRed));
            mBarTextSpace = a.getDimension(R.styleable.IndexableRecyclerView_indexBar_textSpace, getResources().getDimension(R.dimen.space));
    ...
    private void initListener() {
        mRecy.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == state || newState == RecyclerView.SCROLL_STATE_SETTLING) {
                    return;
                }
    ...
    private void initMDOverlay(int color) {
        ...
        // ((TextView) mMDOverlay).setSupportBackgroundTintList(ColorStateList.valueOf(color));
