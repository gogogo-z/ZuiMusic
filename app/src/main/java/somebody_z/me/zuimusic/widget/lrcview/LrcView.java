package somebody_z.me.zuimusic.widget.lrcview;
...
/**
 * Created by Huanxing Zeng on 2017/3/23.
...
public class LrcView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mTextSize = ta.getDimension(R.styleable.LrcView_lrcTextSize, DisplayUtils.dp2px(getContext(), 12));
        mDividerHeight = ta.getDimension(R.styleable.LrcView_lrcDividerHeight, DisplayUtils.dp2px(getContext(), 16));
        ...
        mLabel = TextUtils.isEmpty(mLabel) ? "暂时没有歌词" : mLabel;
    ...
    private void newlineAnimation(int index) {
        ...
        if (mLrcEntryList.get(index) == null) {
            return;
        }
