 ...
 */
public class RecentlyPlayAdapter extends RecyclerView.Adapter<RecentlyPlayAdapter.ViewHolder> {
    ...
    public RecentlyPlayAdapter(Context context, List<ContentBean> songSheetDetailList) {
    ...
    public void refreshList(List<ContentBean> contentBeanList) {
        songSheetDetailList.clear();
        songSheetDetailList.addAll(contentBeanList);
