 ...
 */
public class RankDetailModel implements IModel {
     ...
     */
    public void getRankDetail(Subscription subscription, String type, int offset, int size, final GetSongSheetDetailListener getDetailListener) {
        apiService = ServiceFactory.getInstance().createService(ApiService.class);

        subscription = apiService.getRankDetail(Constants.RANK_DETAIL, type, offset, size, Constants.FIELDS).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<RankDetailBean>() {
                    @Override
                    ...
                    public void onNext(RankDetailBean rankDetailBean) {
                        ...
                        getDetailListener.getSuccess(rankDetailBean);
                    }
                });
    }
    ...
    public interface GetSongSheetDetailListener {
        void getSuccess(RankDetailBean rankDetailBean);
