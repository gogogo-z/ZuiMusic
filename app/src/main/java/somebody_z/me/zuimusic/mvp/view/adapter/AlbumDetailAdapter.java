...
public class AlbumDetailAdapter extends RecyclerView.Adapter<AlbumDetailAdapter.ViewHolder> {
    ...
    public List<AlbumDetailBean.SonglistBean> songSheetDetailList = new ArrayList<>();

    public AlbumDetailAdapter(Context context, List<AlbumDetailBean.SonglistBean> songSheetDetailList) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mOnItemClickListener != null) {
                    // 注意这里使用getTag方法获取数据
                    mOnItemClickListener.onItemClick(view, (AlbumDetailBean.SonglistBean) view.getTag());
                }
            }
        });
    ...
    public interface OnRecyclerViewItemClickListener {
        void onItemClick(View view, AlbumDetailBean.SonglistBean songSheetDetail);

        void onItemMoreClick(AlbumDetailBean.SonglistBean songSheetDetail);
    }
