 ...
 */
public class SongSheetDetailModel implements IModel {
     ...
     */
    public void getSongSheetDetail(Subscription subscription, String listid, final GetSongSheetDetailListener getDetailListener) {
        apiService = ServiceFactory.getInstance().createService(ApiService.class);

        subscription = apiService.getSongSheetDetail(Constants.SONG_SHEET_DETAIL, listid).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<SongSheetDetail>() {
                    @Override
                    ...
                    @Override
                    public void onNext(SongSheetDetail songSheetDetail) {
                        // TODO Auto-generated method stu
                        getDetailListener.getSuccess(songSheetDetail);
                    }
                });
    }
    ...
    public interface GetSongSheetDetailListener {
        void getSuccess(SongSheetDetail songSheetDetail);
